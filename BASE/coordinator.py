...
def final_model_generator():
	...
	model1 = SGDClassifier(penalty="l2",max_iter=1,warm_start=True,class_weight={1:0.542,0:6.464})
...
def create_genisis_model():
	...
	y = data.pop(TARGET)
	genesis_model = SGDClassifier(max_iter=2,warm_start=True,class_weight={1:0.542,0:6.464})
