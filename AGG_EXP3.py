...
def verifier(path,impli):
    ...
    to_process = path+impli+"/EXP3_MODEL_POISON_STUFF/"
    ...
    for x in os.listdir(to_process):
        ...
        if(deci):#All Good
            ...
            print("Simething is wrong with",path,impli)
...
#FINAL_DATA.to_csv("./Visualization_Results/EXP3_RESULT.csv",index=False)
print("EXP3_Results.csv is generated in ./Visualization_Results/EXP3_RESULT.csv.. All the Best Visualization ")
