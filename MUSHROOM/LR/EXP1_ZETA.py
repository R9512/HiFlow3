...
def tester(type,path):
    ...
    if(type == "HiFlow3"):
        ...
        for z in network_data:
            ...
            FINAL_NETWORK["COORDINATOR"]["IN"]+= network_data[z]["BLOCKCHAIN"]["IN"]
            FINAL_NETWORK["COORDINATOR"]["OUT"]+= network_data[z]["BLOCKCHAIN"]["OUT"]
            FINAL_NETWORK["VALIDATORS"]["IN"]+= network_data[z]["BLOCKCHAIN"]["IN"]/5
            FINAL_NETWORK["VALIDATORS"]["OUT"]+= network_data[z]["BLOCKCHAIN"]["OUT"]/5
