...
def final_model_generator():
	...
	model1 = LogisticRegression(penalty="l2",max_iter=1,warm_start=True,class_weight={1:1.433,0:0.768})
...
def create_genisis_model():
	...
	y = data.pop(TARGET)
	genesis_model = LogisticRegression(max_iter=2,warm_start=True,class_weight={1:1.433,0:0.768})
