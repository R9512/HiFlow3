...
if __name__ == "__main__":
    X,y=load_data("../HiFlow3/node_data/"+sys.argv[1]+".csv","OUTCOME",2)#Here
    
    model = LogisticRegression(penalty="l2",max_iter=2,class_weight={1:1.433,0:0.768})
    set_initial_params(model,2,30)
